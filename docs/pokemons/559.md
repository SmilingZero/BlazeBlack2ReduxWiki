...
| 34 | Drain Punch | 75 | 100 | 10 | ![][fighting] | ![][physical] | Priority: 0. Drains half the damage inflicted to heal the user. |
| 38 | Assurance | 60 | 100 | 10 | ![][dark] | ![][physical] | Priority: 0. If the target takes damage this turn for any reason before this move is used, this move has double power. |
| 42 | Zen Headbutt | 80 | 90 | 10 | ![][psychic] | ![][physical] | Priority: 0. Has a 20% chance to make the target flinch. |
| 46 | Crunch | 80 | 100 | 10 | ![][dark] | ![][physical] | Priority: 0. Has a 20% chance to lower the target's Defense by one stage. |
| 50 | High Jump Kick | 130 | 90 | 10 | ![][fighting] | ![][physical] | Priority: 0. If this move misses, is blocked by protect or detect, or has no effect, the user takes damage equal to half of its max HP rounded down.<br><br>This move cannot be used while gravity is in effect. |
