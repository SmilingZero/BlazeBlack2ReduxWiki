...
| 1 | Skill Swap | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. User and target switch abilities.  Ignores accuracy and evasion modifiers.<br><br>If either Pokémon has multitype or wonder guard, this move will fail. |
...
| 26 | Miracle Eye | None | None | 40 | ![][psychic] | ![][status] | Priority: 0. Resets the target's evasion to normal and prevents any further boosting until the target leaves the field.  A dark Pokémon under this effect takes normal damage from psychic moves.  This move itself ignores accuracy and evasion modifiers. |
| 29 | Feather Dance | None | 100 | 15 | ![][flying] | ![][status] | Priority: 0. Lowers the target's Attack by two stages. |
| 32 | Dual Wingbeat | 40 | 90 | 10 | ![][flying] | ![][physical] | Priority: 0. Inflicts regular damage. |
| 35 | Simple Beam | None | 100 | 15 | ![][normal] | ![][status] | Priority: 0. Changes the target's ability to simple. |
