...
| 31 | Mud Bomb | 65 | 85 | 10 | ![][ground] | ![][special] | Priority: 0. Has a 30% chance to lower the target's accuracy by one stage. |
...
| 42 | Aqua Ring | None | None | 20 | ![][water] | ![][status] | Priority: 0. Restores 1/16 of the user's max HP at the end of each turn.  If the user leaves the field, this effect ends.<br><br>This effect is passed on by baton pass. |
| 46 | Muddy Water | 90 | 85 | 10 | ![][water] | ![][special] | Priority: 0. Has a 30% chance to lower the target's accuracy by one stage. |
| 50 | Refresh | None | None | 20 | ![][normal] | ![][status] | Priority: 0. Removes a burn, paralysis, or poison from the user. |
