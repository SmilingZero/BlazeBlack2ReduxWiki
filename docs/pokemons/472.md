...
|: --- :|: --- :|: --- :|
| Hyper Cutter | Poison Heal | Poison Heal |
...
| 25 | Counter | None | 100 | 20 | ![][fighting] | ![][physical] | Priority: -5. Targets the last opposing Pokémon to hit the user with a physical move this turn.  Inflicts twice the damage that move did to the user. |
...
| 64 | Guillotine | None | 30 | 5 | ![][normal] | ![][physical] | Priority: 0. OHKO Move. This move's accuracy is 30% plus 1% for each level the user is higher than the target.  If the user is a lower level than the target, this move will fail. |
