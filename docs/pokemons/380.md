...
| 1 | Simple Beam | None | 100 | 15 | ![][normal] | ![][status] | Priority: 0. Changes the target's ability to simple. |
...
| 1 | Heal Block | None | 100 | 15 | ![][psychic] | ![][status] | Priority: 0. For the next five turns, the target may not use any moves that only restore HP, and move effects that heal the target are disabled.  Moves that steal HP may still be used, but will only inflict damage and not heal the target. |
...
| 10 | Dragon Dance | None | None | 20 | ![][dragon] | ![][status] | Priority: 0. Raises the user's Attack and Speed by one stage each. |
| 14 | Refresh | None | None | 20 | ![][normal] | ![][status] | Priority: 0. Removes a burn, paralysis, or poison from the user. |
| 18 | Breaking Swipe | 60 | 100 | 15 | ![][dragon] | ![][physical] | Priority: 0. Lowers the target's Attack by one stage. |
...
| 26 | Psycho Shift | None | 100 | 10 | ![][psychic] | ![][status] | Priority: 0. If the user has a major status effect and the target does not, the user's status is transferred to the target. |
...
| 38 | Recover | None | None | 10 | ![][normal] | ![][status] | Priority: 0. Heals the user for half its max HP. |
| 42 | Esper Wing | 70 | 100 | 10 | ![][psychic] | ![][special] | Priority: 1. None |
