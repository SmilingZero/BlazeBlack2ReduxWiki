...
| 30 | Focus Energy | None | None | 20 | ![][normal] | ![][status] | Priority: 0. User's critical hit rate is two levels higher until it leaves the field.  If the user has already used focus energy since entering the field, this move will fail.<br><br>This effect is passed on by baton pass. |
| 33 | Poison Tail | 80 | 100 | 10 | ![][poison] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. Has a 10% chance to poison the target. |
...
| 44 | Night Slash | 70 | 100 | 15 | ![][dark] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. |
| 48 | Cross Poison | 90 | 100 | 15 | ![][poison] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. Has a 10% chance to poison the target. |
