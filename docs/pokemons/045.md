...
|: --- :|: --- :|: --- :|
| Thick Fat | Effect Spore | Effect Spore |
...
| 1 | Toxic | None | 90 | 10 | ![][poison] | ![][status] | Priority: 0. Badly poisons the target.  Never misses when used by a poison-type Pokémon. |
...
| 58 | Aromatherapy | None | None | 5 | ![][grass] | ![][status] | Priority: 0. Removes major status effects and confusion from every Pokémon in the user's party. |
| 68 | Solar Beam | 120 | 100 | 10 | ![][grass] | ![][special] | Priority: 0. User charges for one turn before attacking. |
