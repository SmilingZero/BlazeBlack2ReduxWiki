...
| 60 | Zen Headbutt | 80 | 90 | 10 | ![][psychic] | ![][physical] | Priority: 0. Has a 20% chance to make the target flinch. |
| 64 | Dynamic Punch | 100 | 50 | 5 | ![][fighting] | ![][physical] | Priority: 0. Has a 100% chance to confuse the target. |
| 68 | Close Combat | 120 | 100 | 5 | ![][fighting] | ![][physical] | Priority: 0. Inflicts regular damage, then lowers the user's Defense and Special Defense by one stage each. |
| 72 | Shadow Force | 120 | 100 | 5 | ![][ghost] | ![][physical] | Priority: 0. User vanishes for one turn, becoming immune to attack, and hits on the second turn.<br><br>This move ignores the effects of detect and protect.<br><br>This move cannot be selected by sleep talk. |
