...
| 47 | Play Rough | 90 | 90 | 10 | ![][fairy] | ![][physical] | Priority: 0. Has a 10% chance to lower the target's Attack by one stage. |
| 51 | Copycat | None | None | 20 | ![][normal] | ![][status] | Priority: 0. Uses the last move that was used successfully by any Pokémon, including the user.<br><br>This move cannot copy itself, nor roar nor whirlwind.<br><br>This move cannot be copied by mirror move, nor selected by assist, metronome, or sleep talk. |
...
| 59 | Nasty Plot | None | None | 20 | ![][dark] | ![][status] | Priority: 0. Raises the user's Special Attack by two stages. |
