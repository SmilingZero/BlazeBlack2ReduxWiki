...
| 6 | Ominous Wind | 60 | 100 | 5 | ![][ghost] | ![][special] | Priority: 0. Has a 10% chance to raise all of the user's stats one stage. |
...
| 18 | Shadow Sneak | 40 | 100 | 20 | ![][ghost] | ![][physical] | Priority: 1. Inflicts regular damage. |
| 22 | Destiny Bond | None | None | 5 | ![][ghost] | ![][status] | Priority: 0. If the user faints before its next move, the Pokémon that fainted it will automatically faint.  End-of-turn damage is ignored.<br><br>This move cannot be selected by assist or metronome. |
| 26 | Dragon Claw | 85 | 100 | 10 | ![][dragon] | ![][physical] | Priority: 0. High Critical Ratio |
| 30 | Hex | 65 | 100 | 15 | ![][ghost] | ![][special] | Priority: 0. If the target has a major status ailment, this move has double power. |
| 34 | Shadow Claw | 70 | 100 | 90 | ![][ghost] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. |
...
| 50 | Shadow Force | 120 | 100 | 5 | ![][ghost] | ![][physical] | Priority: 0. User vanishes for one turn, becoming immune to attack, and hits on the second turn.<br><br>This move ignores the effects of detect and protect.<br><br>This move cannot be selected by sleep talk. |
