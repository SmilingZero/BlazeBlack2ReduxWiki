...
| 40 | Skill Swap | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. User and target switch abilities.  Ignores accuracy and evasion modifiers.<br><br>If either Pokémon has multitype or wonder guard, this move will fail. |
| 43 | Hex | 65 | 100 | 15 | ![][ghost] | ![][special] | Priority: 0. If the target has a major status ailment, this move has double power. |
...
| 55 | Memento | None | 100 | 10 | ![][dark] | ![][status] | Priority: 0. Lowers the target's Attack and Special Attack by two stages.  User faints. |
