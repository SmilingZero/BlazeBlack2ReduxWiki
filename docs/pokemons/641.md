...
| 10 | Swagger | None | 85 | 15 | ![][normal] | ![][status] | Priority: 0. Raises the target's Attack by two stages, then confuses it.  If the target's Attack cannot be raised by two stages, the confusion is not applied. |
| 15 | Bite | 60 | 100 | 20 | ![][dark] | ![][physical] | Priority: 0. Has a 30% chance to make the target flinch. |
| 20 | Air Cutter | 60 | 95 | 15 | ![][flying] | ![][special] | Priority: 0. User's critical hit rate is one level higher when using this move. |
| 23 | Agility | None | None | 30 | ![][psychic] | ![][status] | Priority: 0. Raises the user's Speed by two stages. |
| 26 | Tailwind | None | None | 15 | ![][flying] | ![][status] | Priority: 0. For the next three turns, all Pokémon on the user's side of the field have their original Speed doubled.  This effect remains if the user leaves the field. |
| 29 | Air Slash | 75 | 95 | 10 | ![][flying] | ![][special] | Priority: 0. Has a 30% chance to make the target flinch. |
...
[641_incarnate]: ../img/animated/641-incarnate.gif

[641_therian]: ../img/animated/641-therian.gif
