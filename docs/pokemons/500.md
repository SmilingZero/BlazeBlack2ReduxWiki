...
| 66 | V-create | 180 | 95 | 5 | ![][fire] | ![][physical] | Priority: 0. Lowers the user's Defense, Special Defense, and Speed by one stage each. |
| 70 | Headlong Rush | 120 | 90 | 5 | ![][ground] | ![][physical] | Priority: 0. Inflicts regular damage, then lowers the user's Defense and Special Defense by one stage each. |
