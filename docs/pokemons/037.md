...
| 13 | Captivate | None | 100 | 20 | ![][normal] | ![][status] | Priority: 0. Lowers the target's Special Attack by two stages.  If the user and target are the same gender, or either is genderless, this move will fail. |
| 16 | Feint Attack | 60 | None | 20 | ![][dark] | ![][physical] | Priority: 0. Ignores accuracy and evasion modifiers. |
| 19 | Fire Spin | 35 | 85 | 15 | ![][fire] | ![][special] | Priority: 0. For the next 2–5 turns, the target cannot leave the field and is damaged for 1/16 its max HP at the end of each turn.<br><br>Has a 3/8 chance each to hit 2 or 3 times, and a 1/8 chance each to hit 4 or 5 times.<br><br>Rapid spin cancels this effect. |
...
| 44 | Inferno | 100 | 65 | 5 | ![][fire] | ![][special] | Priority: 0. Has a 100% chance to burn the target. |
| 48 | Memento | None | 100 | 10 | ![][dark] | ![][status] | Priority: 0. Lowers the target's Attack and Special Attack by two stages.  User faints. |
| 52 | Flare Blitz | 120 | 100 | 15 | ![][fire] | ![][physical] | Priority: 0. User takes 1/3 the damage it inflicts in recoil.  Has a 10% chance to burn the target.  Frozen Pokémon may use this move, in which case they will thaw. |
| 56 | Extrasensory | 80 | 100 | 15 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to make the target flinch. |
| 60 | Grudge | None | None | 5 | ![][ghost] | ![][status] | Priority: 0. If the user faints before it next acts, the move that fainted it will have its PP dropped to 0.  End-of-turn damage does not trigger this effect. |
