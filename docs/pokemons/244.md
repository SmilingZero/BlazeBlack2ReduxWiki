...
| 1 | Roar | None | None | 20 | ![][normal] | ![][status] | Priority: -6. Switches the target out for another of its trainer's Pokémon selected at random.  Wild battles end immediately. |
...
| 14 | Stomp | 65 | 100 | 20 | ![][normal] | ![][physical] | Priority: 0. Has a 30% chance to make the target flinch.<br><br>Power is doubled against Pokémon that have used minimize since entering the field. |
| 18 | Flamethrower | 90 | 100 | 10 | ![][fire] | ![][special] | Priority: 0. Has a 10% chance to burn the target. |
| 22 | Headlong Rush | 120 | 90 | 5 | ![][ground] | ![][physical] | Priority: 0. Inflicts regular damage, then lowers the user's Defense and Special Defense by one stage each. |
| 26 | Raging Fury | 95 | 100 | 10 | ![][fire] | ![][physical] | Priority: 0. Confuses user when subsides (like Outrage) |
...
| 38 | Mega Kick | 120 | 75 | 5 | ![][normal] | ![][physical] | Priority: 0. Inflicts regular damage. |
...
| 46 | Eruption | 150 | 100 | 5 | ![][fire] | ![][special] | Priority: 0. Power increases with the user's remaining HP and is given by `150 * HP / max HP`, to a maximum of 150 when the user has full HP. |
| 50 | Flare Blitz | 120 | 100 | 15 | ![][fire] | ![][physical] | Priority: 0. User takes 1/3 the damage it inflicts in recoil.  Has a 10% chance to burn the target.  Frozen Pokémon may use this move, in which case they will thaw. |
