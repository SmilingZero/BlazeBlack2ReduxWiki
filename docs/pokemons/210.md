...
| 22 | Mimic | None | None | 10 | ![][normal] | ![][status] | Priority: 0. This move is replaced by the target's last successfully used move, and its PP changes to 5. |
...
| 29 | Roar | None | None | 20 | ![][normal] | ![][status] | Priority: -6. Switches the target out for another of its trainer's Pokémon selected at random.  Wild battles end immediately. |
