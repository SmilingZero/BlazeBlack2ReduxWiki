...
| 13 | Bubble Beam | 70 | 100 | 20 | ![][water] | ![][special] | Priority: 0. Has a 10% chance to lower the target's Speed by one stage. |
| 16 | Ancient Power | 60 | 100 | 5 | ![][rock] | ![][special] | Priority: 0. Has a 10% chance to raise all of the user's stats one stage. |
| 18 | Knock Off | 65 | 100 | 20 | ![][dark] | ![][physical] | Priority: 0. Target loses its held item. |
...
| 26 | Chip Away | 70 | 100 | 20 | ![][normal] | ![][physical] | Priority: 0. Damage calculation ignores the target's stat modifiers, including evasion. |
...
| 57 | Crabhammer | 100 | 90 | 10 | ![][water] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. |
...
| 65 | Guillotine | None | 30 | 5 | ![][normal] | ![][physical] | Priority: 0. OHKO Move. This move's accuracy is 30% plus 1% for each level the user is higher than the target.  If the user is a lower level than the target, this move will fail. |
