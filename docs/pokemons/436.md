...
| 42 | Payback | 50 | 100 | 10 | ![][dark] | ![][physical] | Priority: 0. If the target uses a move or switches out this turn before this move is used, this move has double power. |
...
| 50 | Psyshield Bash | 70 | 95 | 10 | ![][psychic] | ![][physical] | Priority: 0. Rasies the user's Defense and Special Defense by one stage. |
