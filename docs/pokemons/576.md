...
| 30 | Fake Out | 40 | 100 | 10 | ![][normal] | ![][physical] | Priority: 3. Causes the target to flinch.  Can only be used on the user's first turn after entering the field. |
| 33 | Helping Hand | None | None | 20 | ![][normal] | ![][status] | Priority: 5. Boosts the power of the target's moves by 50% until the end of this turn.<br><br>This move cannot be copied by mirror move, nor selected by assist or metronome. |
| 36 | Feint Attack | 60 | None | 20 | ![][dark] | ![][physical] | Priority: 0. Ignores accuracy and evasion modifiers. |
| 39 | Magic Room | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. For five turns (including this one), passive effects of held items are ignored, and Pokémon will not use their held items. |
| 41 | Dark Pulse | 80 | Never Miss | 10 | ![][dark] | ![][special] | Priority: 0. Has a 20% chance to make the target flinch. |
| 45 | Future Sight | 120 | 100 | 10 | ![][psychic] | ![][special] | Priority: 0. Inflicts typeless regular damage at the end of the third turn, starting with this one.  This move cannot score a critical hit.  If the target switches out, its replacement will be hit instead.  Damage is calculated at the time this move is used; stat changes and switching out during the delay won't change the damage inflicted.  No move with this effect can be used against the same target again until after the end of the third turn.<br><br>This effect breaks through wonder guard.<br><br>If the target is protected by protect or detect on the turn this move is used, this move will fail.  However, the damage on the third turn will break through protection.<br><br>The damage is applied at the end of the turn, so it ignores endure and focus sash.<br><br>This move cannot be copied by mirror move. |
| 49 | Heal Pulse | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. Heals the target for half its max HP. |
| 53 | Nasty Plot | None | None | 20 | ![][dark] | ![][status] | Priority: 0. Raises the user's Special Attack by two stages. |
| 57 | Heal Block | None | 100 | 15 | ![][psychic] | ![][status] | Priority: 0. For the next five turns, the target may not use any moves that only restore HP, and move effects that heal the target are disabled.  Moves that steal HP may still be used, but will only inflict damage and not heal the target. |
