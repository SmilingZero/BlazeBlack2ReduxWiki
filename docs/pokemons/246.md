...
| 30 | Withdraw | None | None | 40 | ![][water] | ![][status] | Priority: 0. Raises the user's Defense by one stage. |
...
| 42 | Earthquake | 100 | 100 | 10 | ![][ground] | ![][physical] | Priority: 0. Inflicts regular damage.<br><br>If the target is in the first turn of dig, this move will hit with double power. |
