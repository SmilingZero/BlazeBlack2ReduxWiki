...
| 52 | Roost | None | None | 10 | ![][flying] | ![][status] | Priority: 0. Heals the user for half its max HP.  If the user is flying, its flying type is ignored until the end of this turn. |
| 55 | Drill Peck | 80 | 100 | 20 | ![][flying] | ![][physical] | Priority: 0. Inflicts regular damage. |
