...
| 46 | Heal Pulse | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. Heals the target for half its max HP. |
| 50 | Dark Pulse | 80 | Never Miss | 10 | ![][dark] | ![][special] | Priority: 0. Has a 20% chance to make the target flinch. |
| 54 | Heal Block | None | 100 | 15 | ![][psychic] | ![][status] | Priority: 0. For the next five turns, the target may not use any moves that only restore HP, and move effects that heal the target are disabled.  Moves that steal HP may still be used, but will only inflict damage and not heal the target. |
...
| [Victory Road - Ruined Area] | Cave, Normal | 59-62 | 5.0 |
