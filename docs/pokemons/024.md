...
| 29 | Breaking Swipe | 60 | 100 | 15 | ![][dragon] | ![][physical] | Priority: 0. Lowers the target's Attack by one stage. |
| 32 | Poison Tail | 80 | 100 | 10 | ![][poison] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. Has a 10% chance to poison the target. |
| 35 | Acid Spray | 40 | 100 | 20 | ![][poison] | ![][special] | Priority: 0. Lowers the target's Special Defense by two stages. |
...
| 42 | Sucker Punch | 70 | 100 | 5 | ![][dark] | ![][physical] | Priority: 1. If the target has not selected a damaging move this turn, or if the target has already acted this turn, this move will fail.<br><br>This move is not affected by iron fist. |
...
| 52 | Crunch | 80 | 100 | 10 | ![][dark] | ![][physical] | Priority: 0. Has a 20% chance to lower the target's Defense by one stage. |
| 56 | Haze | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Removes stat, accuracy, and evasion modifiers from every Pokémon on the field.<br><br>This does not count as a stat reduction for the purposes of clear body or white smoke. |
| 60 | Gunk Shot | 120 | 80 | 5 | ![][poison] | ![][physical] | Priority: 0. Has a 30% chance to poison the target. |
