...
<tr><td style="width:14%;align:center;vertical-align: bottom;">20</td><td style="width:14%;align:center;vertical-align: bottom;">10</td><td style="width:14%;align:center;vertical-align: bottom;">230</td><td style="width:14%;align:center;vertical-align: bottom;">10</td><td style="width:14%;align:center;vertical-align: bottom;">230</td><td style="width:14%;align:center;vertical-align: bottom;">5</td><td style="width:16%;align:center;vertical-align: bottom;">505</td></tr></table>
...
| 9 | Wrap | 15 | 90 | 20 | ![][normal] | ![][physical] | Priority: 0. For the next 2–5 turns, the target cannot leave the field and is damaged for 1/16 its max HP at the end of each turn.  <br><br>Has a 3/8 chance each to hit 2 or 3 times, and a 1/8 chance each to hit 4 or 5 times. <br><br>Rapid spin cancels this effect. |
...
| 17 | Rock Throw | 50 | 90 | 15 | ![][rock] | ![][physical] | Priority: 0. Inflicts regular damage. |
| 21 | Rest | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. User falls to sleep for two turns, replacing any existing non-volatile status ailments, and immediately regains all its HP. |
...
| 27 | Rock Slide | 75 | 90 | 10 | ![][rock] | ![][physical] | Priority: 0. Has a 30% chance to make the target flinch. |
| 30 | Power Trick | None | None | 10 | ![][psychic] | ![][status] | Priority: 0. The user's original Attack and Defense are swapped.<br><br>This effect is passed on by baton pass. |
| 33 | Gastro Acid | None | 100 | 10 | ![][poison] | ![][status] | Priority: 0. The target's ability is disabled as long as it remains on the field.<br><br>This effect is passed on by baton pass. |
...
| 39 | Stealth Rock | None | None | 20 | ![][rock] | ![][status] | Priority: 0. Spreads sharp rocks around the opposing field, damaging any Pokémon that enters the field for 1/8 its max HP.  This damage is affected by the entering Pokémon's susceptibility to rock moves.<br><br>rapid spin removes this effect from its user's side of the field. |
| 42 | Accelerock | 40 | 100 | 20 | ![][rock] | ![][physical] | Priority: 1. Inflicts regular damage. |
| 46 | Acupressure | None | None | 30 | ![][normal] | ![][status] | Priority: 0. Raises one of the target's stats by two stages.  The raised stat is chosen at random from any stats that can be raised by two stages.  If no stat is eligible, this move will fail.<br><br>If the target has a substitute, this move will have no effect, even if the user is the target.<br><br>This move cannot be copied by mirror move. |
| 50 | Stone Edge | 100 | 80 | 5 | ![][rock] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. |
| 54 | Helping Hand | None | None | 20 | ![][normal] | ![][status] | Priority: 5. Boosts the power of the target's moves by 50% until the end of this turn.<br><br>This move cannot be copied by mirror move, nor selected by assist or metronome. |
| 58 | Shell Smash | None | None | 15 | ![][normal] | ![][status] | Priority: 0. Raises the user's Attack, Special Attack, and Speed by two stages each.  Lowers the user's Defense and Special Defense by one stage each. |
| 62 | Final Gambit | None | 100 | 5 | ![][fighting] | ![][special] | Priority: 0. Inflicts damage equal to the user's remaining HP.  User faints. |
