...
| 25 | Autotomize | None | None | 15 | ![][steel] | ![][status] | Priority: 0. Raises the user's Speed by two stages.  Halves the user's weight; this effect does not stack. |
...
| 31 | Metal Burst | None | 100 | 10 | ![][steel] | ![][physical] | Priority: 0. Targets the last opposing Pokémon to hit the user with a damaging move this turn.  Inflicts 1.5× the damage that move did to the user.  If there is no eligible target, this move will fail.  Type immunity applies, but other type effects are ignored. |
...
| 46 | Iron Tail | 100 | 75 | 15 | ![][steel] | ![][physical] | Priority: 0. Has a 30% chance to lower the target's Defense by one stage. |
