...
| 20 | Haze | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Removes stat, accuracy, and evasion modifiers from every Pokémon on the field.<br><br>This does not count as a stat reduction for the purposes of clear body or white smoke. |
| 20 | Mist | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Pokémon on the user's side of the field are immune to stat-lowering effects for five turns.<br><br>guard swap, heart swap, and power swap may still be used.<br><br>defog used by an opponent will end this effect. |
...
| [Twist Mountain] | Cave, Ice Room, Normal | 69 | 20.0 |
