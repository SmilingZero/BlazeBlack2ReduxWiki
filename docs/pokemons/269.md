...
| 21 | Sludge | 70 | 100 | 15 | ![][poison] | ![][special] | Priority: 0. Has a 30% chance to poison the target. |
| 25 | Signal Beam | 75 | 100 | 15 | ![][bug] | ![][special] | Priority: 0. Has a 10% chance to confuse the target. |
| 29 | Moonlight | None | None | 5 | ![][fairy] | ![][status] | Priority: 0. Heals the user for half its max HP.<br><br>During sunny day, the healing is increased to 2/3 max HP.<br><br>During hail, rain dance, or sandstorm, the healing is decreased to 1/4 max HP. |
| 33 | Bug Buzz | 90 | 100 | 10 | ![][bug] | ![][special] | Priority: 0. Has a 10% chance to lower the target's Special Defense by one stage. |
| 37 | Light Screen | None | None | 30 | ![][psychic] | ![][status] | Priority: 0. Reduces damage from special attacks by half for five turns. In double battles, the reduction is 1/3. |
| 41 | Toxic | None | 90 | 10 | ![][poison] | ![][status] | Priority: 0. Badly poisons the target.  Never misses when used by a poison-type Pokémon. |
...
| 49 | Protect | None | None | 10 | ![][normal] | ![][status] | Priority: 4. No moves will hit the user for the remainder of this turn. If the user is last to act this turn, this move will fail. Success rate drops by 1/2 on successive attempts. |
...
| Species | Method | Move |
|: --- :|: --- :|: --- :|
| Cascoon | Tutor | Iron Defense |
| Cascoon | Lvl 1 | Harden |
| Cascoon | Lvl 7 | Iron Defense |
| Wurmple | Tutor | Snore |
