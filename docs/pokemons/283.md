...
| 23 | Signal Beam | 75 | 100 | 15 | ![][bug] | ![][special] | Priority: 0. Has a 10% chance to confuse the target. |
| 26 | Psybeam | 65 | 100 | 20 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to confuse the target. |
| 29 | Attract | None | 100 | 15 | ![][normal] | ![][status] | Priority: 0. Causes the target to fall in love with the user, giving it a 50% chance to do nothing each turn.  If the user and target are the same gender, or either is genderless, this move will fail.  If either Pokémon leaves the field, this effect ends. |
