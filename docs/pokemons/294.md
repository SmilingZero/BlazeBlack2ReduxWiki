...
| 41 | Extrasensory | 80 | 100 | 15 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to make the target flinch. |
| 45 | Fling | None | 100 | 10 | ![][dark] | ![][physical] | Priority: 0. Power and type are determined by the user's held item.  The item is consumed.  If the user is not holding an item, or its item has no set type and power, this move will fail.<br><br>This move ignores sticky hold.<br><br>If the user is under the effect of embargo, this move will fail. |
| 49 | Synchronoise | 120 | 100 | 10 | ![][psychic] | ![][special] | Priority: 0. Only Pokémon that share a type with the user will take damage from this move. |
