...
| 1 | Whirlwind | None | Never Miss | 20 | ![][normal] | ![][status] | Priority: -6. Switches the target out for another of its trainer's Pokémon selected at random.  Wild battles end immediately.<br><br>Doesn't affect Pokémon with suction cups or under the effect of ingrain. |
