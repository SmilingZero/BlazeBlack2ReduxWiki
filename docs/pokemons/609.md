...
|: --- :|: --- :|: --- :|
| Flash Fire | Flame Body | Shadow Tag |
...
|: --- :|: --- :|: --- :|: --- :|: --- :|: --- :|: --- :|: --- :|
| 1 | Acid Armor | None | None | 20 | ![][poison] | ![][status] | Priority: 0. Raises the user's Defense by two stages. |
...
| 1 | Night Shade | None | 100 | 15 | ![][ghost] | ![][special] | Priority: 0. Inflicts damage equal to the user's level.  Type immunity applies, but other type effects are ignored. |
