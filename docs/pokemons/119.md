...
| 33 | Captivate | None | 100 | 20 | ![][normal] | ![][status] | Priority: 0. Lowers the target's Special Attack by two stages.  If the user and target are the same gender, or either is genderless, this move will fail. |
...
| 49 | Smart Strike | 70 | None | 10 | ![][steel] | ![][physical] | Priority: 0. Ignores accuracy and evasion modifiers. |
| 53 | Megahorn | 120 | 85 | 10 | ![][bug] | ![][physical] | Priority: 0. Inflicts regular damage. |
