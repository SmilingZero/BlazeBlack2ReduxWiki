...
| 15 | Agility | None | None | 30 | ![][psychic] | ![][status] | Priority: 0. Raises the user's Speed by two stages. |
...
| 21 | Focus Energy | None | None | 20 | ![][normal] | ![][status] | Priority: 0. User's critical hit rate is two levels higher until it leaves the field.  If the user has already used focus energy since entering the field, this move will fail.<br><br>This effect is passed on by baton pass. |
...
| 25 | Coil | None | None | 20 | ![][poison] | ![][status] | Priority: 0. Raises the user's Attack, Defense, and accuracy by one stage each. |
| 27 | Flame Wheel | 75 | 100 | 20 | ![][fire] | ![][physical] | Priority: 0. Has a 10% chance to burn the target.  Frozen Pokémon may use this move, in which case they will thaw. |
...
| 40 | Super Fang | None | 90 | 10 | ![][normal] | ![][physical] | Priority: 0. Inflicts typeless damage equal to half the target's remaining HP. |
