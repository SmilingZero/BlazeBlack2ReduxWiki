...
| 54 | Haze | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Removes stat, accuracy, and evasion modifiers from every Pokémon on the field.<br><br>This does not count as a stat reduction for the purposes of clear body or white smoke. |
