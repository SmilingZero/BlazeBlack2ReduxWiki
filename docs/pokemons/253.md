...
| 49 | Leaf Blade | 90 | 100 | 15 | ![][grass] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. |
| 52 | Quick Guard | None | None | 15 | ![][fighting] | ![][status] | Priority: 3. Moves with priority greater than 0 will not hit friendly Pokémon for the remainder of this turn.  If the user is last to act this turn, this move will fail.<br><br>This move cannot be selected by assist or metronome. |
| 55 | Leaf Storm | 130 | 90 | 5 | ![][grass] | ![][special] | Priority: 0. Inflicts regular damage, then lowers the user's Special Attack by two stages. |
