...
| 10 | Protect | None | None | 10 | ![][normal] | ![][status] | Priority: 4. No moves will hit the user for the remainder of this turn. If the user is last to act this turn, this move will fail. Success rate drops by 1/2 on successive attempts. |
...
| 34 | Copycat | None | None | 20 | ![][normal] | ![][status] | Priority: 0. Uses the last move that was used successfully by any Pokémon, including the user.<br><br>This move cannot copy itself, nor roar nor whirlwind.<br><br>This move cannot be copied by mirror move, nor selected by assist, metronome, or sleep talk. |
| 38 | Extrasensory | 80 | 100 | 15 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to make the target flinch. |
| 42 | Charm | None | 100 | 20 | ![][fairy] | ![][status] | Priority: 0. Lowers the target's Attack by two stages. |
