...
| 33 | Haze | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Removes stat, accuracy, and evasion modifiers from every Pokémon on the field.<br><br>This does not count as a stat reduction for the purposes of clear body or white smoke. |
| 36 | Whirlwind | None | Never Miss | 20 | ![][normal] | ![][status] | Priority: -6. Switches the target out for another of its trainer's Pokémon selected at random.  Wild battles end immediately.<br><br>Doesn't affect Pokémon with suction cups or under the effect of ingrain. |
...
| 55 | Hypnosis | None | 60 | 20 | ![][psychic] | ![][status] | Priority: 0. Puts the target to sleep. |
| 59 | Air Slash | 75 | 95 | 10 | ![][flying] | ![][special] | Priority: 0. Has a 30% chance to make the target flinch. |
| 63 | Wide Guard | None | None | 10 | ![][rock] | ![][status] | Priority: 3. Moves with multiple targets will not hit friendly Pokémon for the remainder of this turn.  If the user is last to act this turn, this move will fail.<br><br>This move cannot be selected by assist or metronome. |
| 67 | Brave Bird | 120 | 100 | 15 | ![][flying] | ![][physical] | Priority: 0. User takes 1/3 the damage it inflicts in recoil. |
...
| [Wellspring Cave] | Cave, Normal | 68 | 1.0 |
| [Dreamyard] | Grass, Basement, Doubles | 69 | 20.0 |
