...
| 33 | Chip Away | 70 | 100 | 20 | ![][normal] | ![][physical] | Priority: 0. Damage calculation ignores the target's stat modifiers, including evasion. |
...
| 52 | Belly Drum | None | None | 10 | ![][normal] | ![][status] | Priority: 0. User pays half its max HP to raise its Attack to +6 stages.  If the user cannot pay the HP cost, this move will fail. |
...
| [Celestial Tower] | Floor, 3F | 40-43 | 10.0 |
