...
| 22 | Aurora Beam | 75 | 100 | 20 | ![][ice] | ![][special] | Priority: 0. Has a 10% chance to lower the target's Attack by one stage. |
...
| 28 | Slack Off | None | None | 10 | ![][normal] | ![][status] | Priority: 0. Heals the user for half its max HP. |
