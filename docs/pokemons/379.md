...
|: --- :|: --- :|: --- :|
| Heatproof | Clear Body | Light Metal |
...
| 6 | Metal Claw | 50 | 95 | 35 | ![][steel] | ![][physical] | Priority: 0. Has a 10% chance to raise the user's Attack one stage. |
...
| 26 | Iron Defense | None | None | 15 | ![][steel] | ![][status] | Priority: 0. Raises the user's Defense by two stages. |
