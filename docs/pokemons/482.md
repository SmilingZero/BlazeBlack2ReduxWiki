...
| 34 | Last Resort | 140 | 100 | 5 | ![][normal] | ![][physical] | Priority: 0. This move can only be used if each of the user's other moves has been used at least once since the user entered the field.  If this is the user's only move, this move will fail. |
...
| 46 | Double Hit | 35 | 90 | 10 | ![][normal] | ![][physical] | Priority: 0. Hits twice in one turn. |
| 50 | Esper Wing | 70 | 100 | 10 | ![][psychic] | ![][special] | Priority: 1. None |
