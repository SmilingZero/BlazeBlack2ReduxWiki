...
| 55 | Nasty Plot | None | None | 20 | ![][dark] | ![][status] | Priority: 0. Raises the user's Special Attack by two stages. |
| 58 | Psychic | 90 | 100 | 10 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to lower the target's Special Defense by one stage. |
| 61 | Recover | None | None | 10 | ![][normal] | ![][status] | Priority: 0. Heals the user for half its max HP. |
...
| 69 | Psycho Boost | 140 | 90 | 5 | ![][psychic] | ![][special] | Priority: 0. Inflicts regular damage, then lowers the user's Special Attack by two stages. |
