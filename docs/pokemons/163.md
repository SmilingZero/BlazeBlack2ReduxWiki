...
| 31 | Extrasensory | 80 | 100 | 15 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to make the target flinch. |
| 34 | Feather Dance | None | 100 | 15 | ![][flying] | ![][status] | Priority: 0. Lowers the target's Attack by two stages. |
| 37 | Agility | None | None | 30 | ![][psychic] | ![][status] | Priority: 0. Raises the user's Speed by two stages. |
| 40 | Synchronoise | 120 | 100 | 10 | ![][psychic] | ![][special] | Priority: 0. Only Pokémon that share a type with the user will take damage from this move. |
