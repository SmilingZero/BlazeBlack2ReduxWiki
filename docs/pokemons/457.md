...
| 18 | Roost | None | None | 10 | ![][flying] | ![][status] | Priority: 0. Heals the user for half its max HP.  If the user is flying, its flying type is ignored until the end of this turn. |
...
| 34 | Silver Wind | 60 | 100 | 5 | ![][bug] | ![][special] | Priority: 0. Has a 10% chance to raise all of the user's stats one stage. |
| 39 | Aqua Ring | None | None | 20 | ![][water] | ![][status] | Priority: 0. Restores 1/16 of the user's max HP at the end of each turn.  If the user leaves the field, this effect ends.<br><br>This effect is passed on by baton pass. |
...
| 55 | Soak | None | 100 | 20 | ![][water] | ![][status] | Priority: 0. Changes the target to pure water-type until it leaves the field.  If the target has multitype, this move will fail. |
| 59 | Quiver Dance | None | None | 20 | ![][bug] | ![][status] | Priority: 0. Raises the user's Special Attack, Special Defense, and Speed by one stage each. |
| 63 | Hydro Pump | 110 | 80 | 5 | ![][water] | ![][special] | Priority: 0. Inflicts regular damage. |
