...
| 10 | Roar | None | None | 20 | ![][normal] | ![][status] | Priority: -6. Switches the target out for another of its trainer's Pokémon selected at random.  Wild battles end immediately. Doesn't affect Pokémon with suction cups or under the effect of ingrain. Bypasses accuracy checks. |
...
| 38 | Double Hit | 35 | 90 | 10 | ![][normal] | ![][physical] | Priority: 0. Hits twice in one turn. |
