...
| 34 | Screech | None | 85 | 40 | ![][normal] | ![][status] | Priority: 0. Lowers the target's Defense by two stages. |
| 35 | Shadow Punch | 90 | None | 20 | ![][ghost] | ![][physical] | Priority: 0. Ignores accuracy and evasion modifiers. |
| 39 | Sludge Wave | 95 | 100 | 10 | ![][poison] | ![][special] | Priority: 0. Has a 10% chance to poison the target. |
| 43 | Acid Armor | None | None | 20 | ![][poison] | ![][status] | Priority: 0. Raises the user's Defense by two stages. |
| 47 | Mean Look | None | None | 5 | ![][normal] | ![][status] | Priority: 0. The target cannot switch out normally.  Ignores accuracy and evasion modifiers.  This effect ends when the user leaves the field.<br><br>The target may still escape by using baton pass, u turn, or a shed shell.<br><br>Both the user and the target pass on this effect with baton pass. |
...
| 59 | Memento | None | 100 | 10 | ![][dark] | ![][status] | Priority: 0. Lowers the target's Attack and Special Attack by two stages.  User faints. |
...
|: -- :|: -- :|: -- :|: -- :|
| [Castelia Sewers] | Surf, Dark Spot | 35-45 | 5.0 |
