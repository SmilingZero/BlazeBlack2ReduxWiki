...
| 4 | Mist | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Pokémon on the user's side of the field are immune to stat-lowering effects for five turns.<br><br>guard swap, heart swap, and power swap may still be used.<br><br>defog used by an opponent will end this effect. |
...
|: -- :|: -- :|: -- :|: -- :|
| [Undella Bay] | Surf, Dark Spot, Undella Bay | 40-46 | 5.0 |
