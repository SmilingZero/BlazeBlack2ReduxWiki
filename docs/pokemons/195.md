...
| 13 | Haze | None | None | 30 | ![][ice] | ![][status] | Priority: 0. Removes stat, accuracy, and evasion modifiers from every Pokémon on the field. |
...
| 33 | Counter | None | 100 | 20 | ![][fighting] | ![][physical] | Priority: -5. Targets the last opposing Pokémon to hit the user with a physical move this turn.  Inflicts twice the damage that move did to the user. |
