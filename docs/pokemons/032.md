...
| 40 | Poison Tail | 80 | 100 | 10 | ![][poison] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. Has a 10% chance to poison the target. |
| 44 | Scorching Sands | 70 | 100 | 10 | ![][ground] | ![][special] | Priority: 0. Inflicts regular damage. |
