...
| 52 | Leech Seed | None | 90 | 10 | ![][grass] | ![][status] | Priority: 0. Plants a seed on the target that drains 1/8 of its max HP at the end of every turn and heals the user for the amount taken. |
