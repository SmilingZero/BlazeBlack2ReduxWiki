...
| 42 | Poison Tail | 80 | 100 | 10 | ![][poison] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. Has a 10% chance to poison the target. |
| 46 | Steamroller | 100 | 90 | 10 | ![][bug] | ![][physical] | Priority: 0. Has a 30% chance to make the target flinch.<br><br>Power is doubled against Pokémon that have used minimize since entering the field. |
| 50 | Take Down | 90 | 85 | 20 | ![][normal] | ![][physical] | Priority: 0. User takes 1/4 the damage it inflicts in recoil. |
