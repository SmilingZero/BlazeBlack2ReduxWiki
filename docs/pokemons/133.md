...
| 25 | Mimic | None | None | 10 | ![][normal] | ![][status] | Priority: 0. This move is replaced by the target's last successfully used move, and its PP changes to 5. |
