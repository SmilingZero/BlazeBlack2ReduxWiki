...
| 29 | Sludge Bomb | 90 | 100 | 10 | ![][poison] | ![][special] | Priority: 0. Has a 30% chance to poison the target. |
| 32 | Toxic | None | 90 | 10 | ![][poison] | ![][status] | Priority: 0. Badly poisons the target.  Never misses when used by a poison-type Pokémon. |
...
| 60 | Wring Out | None | 100 | 5 | ![][normal] | ![][special] | Priority: 0. Power directly relates to the target's relative remaining HP, given by `1 + 120 * current HP / max HP`, to a maximum of 121. |
