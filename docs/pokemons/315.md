...
| 27 | Leaf Tornado | 70 | 100 | 10 | ![][grass] | ![][special] | Priority: 0. Has a 30%  chance to drop target's Accuracy by one stage |
| 30 | Ingrain | None | None | 20 | ![][grass] | ![][status] | Priority: 0. Prevents the user from switching out.  User regains 1/16 of its max HP at the end of every turn.  If the user was immune to ground attacks, it will now take normal damage from them.<br><br>roar and whirlwind will not affect the user.  The user cannot use magnet rise.<br><br>The user may still use u turn to leave the field.<br><br>This effect can be passed with baton pass. |
| 34 | Sludge | 70 | 100 | 15 | ![][poison] | ![][special] | Priority: 0. Has a 30% chance to poison the target. |
| 38 | Synthesis | None | None | 5 | ![][grass] | ![][status] | Priority: 0. Heals the user for half its max HP, plus modifiers from weather. |
| 42 | Petal Dance | 120 | 100 | 10 | ![][grass] | ![][special] | Priority: 0. User is forced to attack with this move for 2–3 turns,selected at random.  After the last hit, the user becomes confused.<br><br>safeguard does not protect against the confusion from this move. |
| 46 | Extrasensory | 80 | 100 | 15 | ![][psychic] | ![][special] | Priority: 0. Has a 10% chance to make the target flinch. |
| 50 | Aromatherapy | None | None | 5 | ![][grass] | ![][status] | Priority: 0. Removes major status effects and confusion from every Pokémon in the user's party. |
| 54 | Sleep Powder | None | 75 | 15 | ![][grass] | ![][status] | Priority: 0. Puts the target to sleep. |
...
| [Pinwheel Forest - Inside] | Grass, Normal | 65 | 5.0 |
