...
| 26 | Sing | None | 55 | 15 | ![][normal] | ![][status] | Priority: 0. Puts the target to sleep. |
| 30 | Wake-Up Slap | 70 | 100 | 10 | ![][fighting] | ![][physical] | Priority: 0. If the target is sleeping, this move has double power, and the target wakes up. |
...
| 42 | Dream Eater | 100 | 100 | 15 | ![][psychic] | ![][special] | Priority: 0. Fails if not used on a sleeping Pokémon.   Drains half the damage inflicted to heal the user. |
