...
| 52 | Wood Hammer | 120 | 100 | 15 | ![][grass] | ![][physical] | Priority: 0. User takes 1/3 the damage it inflicts in recoil. |
| 55 | Outrage | 120 | 100 | 10 | ![][dragon] | ![][physical] | Priority: 0. User is forced to attack with this move for 2–3 turns,selected at random.  After the last hit, the user becomes confused.<br><br>safeguard does not protect against the confusion from this move. |
