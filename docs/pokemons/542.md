...
| 22 | Silver Wind | 60 | 100 | 5 | ![][bug] | ![][special] | Priority: 0. Has a 10% chance to raise all of the user's stats one stage. |
| 24 | Air Slash | 75 | 95 | 10 | ![][flying] | ![][special] | Priority: 0. Has a 30% chance to make the target flinch. |
...
| 29 | Helping Hand | None | None | 20 | ![][normal] | ![][status] | Priority: 5. Boosts the power of the target's moves by 50% until the end of this turn.<br><br>This move cannot be copied by mirror move, nor selected by assist or metronome. |
| 32 | Grass Whistle | None | 65 | 15 | ![][grass] | ![][status] | Priority: 0. Puts the target to sleep. |
...
| 48 | Lunge | 80 | 100 | 15 | ![][bug] | ![][physical] | Priority: 0. Lowers the target's Attack by one stage. |
| 52 | Heal Bell | None | None | 5 | ![][normal] | ![][status] | Priority: 0. Removes major status effects and confusion from every Pokémon in the user's party. |
| 56 | Camouflage | None | None | 20 | ![][normal] | ![][status] | Priority: 0. User's type changes according to the terrain.<br><br>Terrain        | New type<br>-------------- | --------------<br>Building       | normal<br>Cave           | rock<br>Desert         | ground<br>Grass          | grass<br>Mountain       | rock<br>Ocean          | water<br>Pond           | water<br>Road           | ground<br>Snow           | ice<br>Tall grass     | grass<br><br>In Pokémon Battle Revolution:<br><br>Terrain        | New type<br>-------------- | --------------<br>Courtyard      | normal<br>Crystal        | rock<br>Gateway        | water<br>Magma          | rock<br>Main Street    | normal<br>Neon           | normal<br>Stargazer      | rock<br>Sunny Park     | grass<br>Sunset         | ground<br>Waterfall      | grass |
| 60 | Entrainment | None | 100 | 15 | ![][normal] | ![][status] | Priority: 0. Changes the target's ability to match the user's.  This effect ends when the target leaves battle. |
