...
| 32 | Endeavor | None | 100 | 5 | ![][normal] | ![][physical] | Priority: 0. Inflicts exactly enough damage to lower the target's HP to equal the user's.  If the target's HP is not higher than the user's, this move has no effect.  Type immunity applies, but other type effects are ignored.  This effect counts as damage for moves that respond to damage. |
| 35 | Fury Cutter | 30 | 95 | 20 | ![][bug] | ![][physical] | Priority: 0. Power doubles after every time this move is used, whether consecutively or not, maxing out at 16x.  If this move misses or the user leaves the field, power resets. |
| 38 | Body Slam | 85 | 100 | 15 | ![][normal] | ![][physical] | Priority: 0. Has a 30% chance to paralyze the target. |
| 42 | Aqua Jet | 40 | 100 | 20 | ![][water] | ![][physical] | Priority: 1. Inflicts regular damage. |
| 46 | Crunch | 80 | 100 | 10 | ![][dark] | ![][physical] | Priority: 0. Has a 20% chance to lower the target's Defense by one stage. |
| 50 | Dragon Dance | None | None | 20 | ![][dragon] | ![][status] | Priority: 0. Raises the user's Attack and Speed by one stage each. |
| 54 | Crabhammer | 100 | 90 | 10 | ![][water] | ![][physical] | Priority: 0. User's critical hit rate is one level higher when using this move. |
...
| 62 | Guillotine | None | 30 | 5 | ![][normal] | ![][physical] | Priority: 0. OHKO Move. This move's accuracy is 30% plus 1% for each level the user is higher than the target.  If the user is a lower level than the target, this move will fail. |
